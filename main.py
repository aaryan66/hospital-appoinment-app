...
if user_input == "OPD":
    ...
    #OPD Tomorrow
    if opd_time == "Tomorrow" or "tomorrow":
        ...
        doctors_opd_tomorrow_list = [random.sample(doctors_opd_today_list,2), "Dr Rajesh Singh Thakuri", "Dr Ram Thapa" "Dr Laju Basnet", "Dr Rahul Sharma", "Dr Sumit Chaulagain"]
        doctors_opd_tomorrow_print = random.sample(doctors_opd_tomorrow_list, 5)
